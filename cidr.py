...
def bin_dec(b): #b is a binary string
    d = 0 #d is the return decimal value
...
''' this python code takes a CIDR input, converts it to binary, then separated the four bits into four binary octets. the octets from binary to decimal ''' 
